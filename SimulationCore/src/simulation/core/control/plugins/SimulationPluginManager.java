...
/**
 * Instantiates the {@link ISimulationPlugin}s defined by all active bundles.
 * Plugin instantiation is only done on object creation of this class.
 * Furthermore, this class allows the installing and uninstalling of new
 * bundles.
 * 
...
public class SimulationPluginManager {
	...
	/**
	 * Instantiates the {@link ISimulationPlugin} objects which are defined by active
	 * bundles.
	 * 
	 * @param context
	 */
	...
	private void instantiateISimulationPlugins() {
		...
		for (IConfigurationElement configElement : configurations) {
			...
			try {
				instantiatedExtension = configElement
	...
	/**
	 * Installs and starts a new bundle. To access a ISimulationPlugin object
	 * defined by the new bundle, the application must be restarted and this
	 * object reinstantiated.
	 * 
	 * @param filePath
	 *            The path to the bundle which should be installed. E.g. the
	 *            path to a *.jar file.
	 * @throws FileNotFoundException
	 * @throws BundleException
	 */
	public void installBundle(String filePath) throws FileNotFoundException,
			BundleException {
		...
		try {
			...
			// throwing the exception again, so that the calling class also
			// reacts on the error.
			throw e;
		}
	}
	...
	/**
	 * Uninstalls the bundle which defines the passed ISimulationPlugin.
	 * Subsequently, the application should be restarted and this class
	 * reinstantiated.
	 * 
	 * @param plugin
	 *            The plugin, of which the defining bundle should be
	 *            uninstalled.
	 * @throws BundleException
	 */
	public void uninstallBundle(ISimulationPlugin plugin)
			throws BundleException {
