...
//	@Test
	public void bigDecimalTest(){
		BigDecimal bigDivident = new BigDecimal("1000000000000000000000000000000");
		BigDecimal bigDivisor = new BigDecimal("3000000000000000000000000000000");
		
		BigDecimal bigQuotient = bigDivident.divide(bigDivisor, new MathContext(50));
	...
	public void computeExpectedUtilitiesTest(){
		...
		for(BigDecimal[] stageChoosenActionNumbers : engine.getChoosenActionNumbers()){
			...
			for(int i=0; i<stageChoosenActionNumbers.length; i++){
				BigDecimal anteil = stageChoosenActionNumbers[i].divide(sum, mathContext);
