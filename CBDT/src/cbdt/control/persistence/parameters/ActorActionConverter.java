...
public class ActorActionConverter implements Converter{
	...
	public Object unmarshal(HierarchicalStreamReader reader,
        ...
        while (reader.hasMoreChildren()) {
            reader.moveDown();
            if (ParametersPersistenceManager.ACTOR_ACTION_OUTCOME_NODE_NAME.equals(reader.getNodeName())) {
                    ActorActionOutcome actorActionOutcome = (ActorActionOutcome)context.convertAnother(actorAction, ActorActionOutcome.class);
