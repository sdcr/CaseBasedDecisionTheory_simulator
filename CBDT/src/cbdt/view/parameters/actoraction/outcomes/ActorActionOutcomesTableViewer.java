...
import cbdt.view.parameters.actoraction.outcomes.listeners.AddOutcomeSelectionListener;
...
public class ActorActionOutcomesTableViewer extends TableViewer {
	...
	public ActorActionOutcomesTableViewer(ActorActionComposite parent, int style) {
		...
		removeColumnLabelProvider = columnFactory.getRemoveColumnLabelProvider();
