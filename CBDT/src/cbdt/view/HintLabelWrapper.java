...
/**
 * A label which is supposed to indicate to the user that there is a 
 * problem with an entered parameter.
 * This class is an opaque wrapper, in the sense that the wrapped object is 
 * not accessible.
 * @author S-lenovo
 */
public class HintLabelWrapper {
	...
	/**
	 * See Label's documentation for {@link #org.eclipse.swt.widgets.Label.setVisible(boolean) setVisible()}.
	 */
