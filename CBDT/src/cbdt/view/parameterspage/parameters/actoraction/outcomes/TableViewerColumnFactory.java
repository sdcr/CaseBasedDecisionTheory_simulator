...
/**
 * A factory class which produces columns for the
 * {@link ActorActionOutcomesTableViewer}.
 * 
...
public class TableViewerColumnFactory {
	...
	/**
	 * Creates the probability, utility and "remove" columns of this table
	 * viewer.
	 */
	void createColumns(ActorActionOutcomesTableViewer tableViewer) {
		TableViewerColumn probabilityColumn = createTableViewerColumn(
				tableViewer, tableTitles[0], widths[0], 0);
		...
		probabilityColumn.setEditingSupport(new ProbabilityEditingSupport(
				tableViewer));

		TableViewerColumn utilityColumn = createTableViewerColumn(tableViewer,
				tableTitles[1], widths[1], 1);
		...
		TableViewerColumn removeIconColumn = createTableViewerColumn(
				tableViewer, tableTitles[2], widths[2], 2);
