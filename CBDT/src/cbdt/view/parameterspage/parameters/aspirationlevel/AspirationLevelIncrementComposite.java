...
import cbdt.view.parameterspage.parameters.aspirationlevel.listeners.UseAspirationLevelIncrementSelectionListener;
...
public class AspirationLevelIncrementComposite extends
	...
	public void update(Observable o, Object arg) {
		if (o instanceof Parameters) {
			...
			boolean usingAspirationLevelIncrement = params.isIncrementingAspirationLevelSparsely();
